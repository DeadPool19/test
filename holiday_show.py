...
riqi=tk.Label(window,text='Dates').place(x=10,y=10)
jiaqi=tk.Label(window,text='Holidays').place(x=10,y=40)
zhongjian=tk.Label(window,text='to').place(x=150,y=10)

riqientry1_var=tk.StringVar()
riqientry2_var=tk.StringVar()
riqientry1=tk.Entry(window,width=15,textvariable=riqientry1_var).place(x=50,y=10)
riqientry2=tk.Entry(window,width=15,textvariable=riqientry2_var).place(x=180,y=10)
...
cb=tk.Button(window,text='Check',command=check_holiday).place(x=300,y=10)
